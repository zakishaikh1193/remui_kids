<?php
/**
 * School Manager - School Settings
 * Configure school/department settings
 * 
...
if (!$company_user || $company_user->managertype != 2) {
    throw new moodle_exception('nopermissions', 'error', '', 'access school manager settings page');
}

$department = $DB->get_record('department', ['id' => $company_user->departmentid]);

$PAGE->set_context($context);
$PAGE->set_url('/theme/remui_kids/school_manager/school_settings.php');
...
<div style="max-width: 1400px; margin: 0 auto; padding: 2rem;">
    <div style="background: white; border-radius: 12px; padding: 3rem; text-align: center; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.08);">
        ...
        <h1 style="font-size: 2rem; color: #2c3e50; margin-bottom: 1rem;">School Settings</h1>
        <p style="font-size: 1.1rem; color: #6c757d; margin-bottom: 2rem;">
            Coming soon! Configure settings for <?php echo format_string($department->name); ?>.
        </p>
