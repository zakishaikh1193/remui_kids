    ...
    return {
        init: function() {
            $(document).ready(function() {
                this.initializeBootstrapCompatibility();
                this.fixDropdownConflicts();
                this.ensureProperEventHandling();
            }.bind(this));
        },

        initializeBootstrapCompatibility: function() {
            // Check for Bootstrap version and initialize accordingly
            var bootstrapVersion = this.detectBootstrapVersion();
            
            if (bootstrapVersion === 5) {
                this.initializeBootstrap5();
            } else if (bootstrapVersion === 4) {
                this.initializeBootstrap4();
            } else {
                // Fallback for older versions or missing Bootstrap
                this.initializeFallbackDropdowns();
            }
        },

        detectBootstrapVersion: function() {
        ...
        initializeFallbackDropdowns: function() {
        ...
        ensureProperEventHandling: function() {
